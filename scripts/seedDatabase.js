...
const sampleData = {
  ...
  vendors: [
    ...
    },
    {
      name: "Asian Paints",
      contact: "Neha Verma",
      email: "help@asianpaints.com",
      phone: "+91-22-7890-1234",
      address: "Mumbai, Maharashtra, India",
    },
    {
      name: "Fenesta",
      contact: "Arvind Joshi",
      email: "windows@fenesta.com",
    ...
    },
    {
      ...
      contact: "Deepak Jain",
      email: "tiles@kajariaceramics.com",
    ...
    },
    {
      ...
      contact: "Rohit Sinha",
      email: "roofing@tatabluescope.com",
    ...
    },
    {
      name: "JCB India Ltd.",
      contact: "Kiran Desai",
      email: "machinery@jcb.com",
      phone: "+91-124-5678-9012",
      address: "Ballabgarh, Haryana, India",
    },
    {
      name: "Leica Geosystems",
      contact: "Sanjay Kapoor",
      email: "survey@leica.com",
      phone: "+91-22-2345-6789",
      address: "Mumbai, Maharashtra, India",
    },
    {
    ...
    },
    {
      name: "Alufase",
      contact: "Nitin Rao",
      email: "scaffold@alufase.com",
      phone: "+91-22-5678-9012",
      address: "Mumbai, Maharashtra, India",
    },
    {
      name: "Hilti India",
      contact: "Vivek Agarwal",
      email: "fixings@hilti.com",
      phone: "+91-22-6789-0123",
      address: "Mumbai, Maharashtra, India",
    },
    {
      name: "Greenply",
      contact: "Shweta Tiwari",
      email: "plywood@greenply.com",
  ...
  customers: [
    ...
    },
    {
      ...
      address:
        "321 Business Blvd, Bandra Kurla Complex, Mumbai, Maharashtra 400051",
    },
    {
    ...
    },
    {
      ...
      address:
        "456 Excellence Avenue, Banashankari, Bangalore, Karnataka 560070",
    },
    {
  ...
  try {
    ...
    for (const prodData of productSeed(categoryNameToId)) {
      try {
        ...
        console.error(
          `Error creating product ${prodData.name}:`,
          error.message
        );
      }
    }
    ...
    if (products.length === 0) {
      throw new Error(
        "No products were created. Cannot proceed with creating orders and sales."
      );
    }
